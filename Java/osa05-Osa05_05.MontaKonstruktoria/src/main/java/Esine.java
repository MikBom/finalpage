...
public class Esine {
    ...
    public Esine(String nimi) {
        ...
        this.paino = 1;
    } //luo esineen annetulla nimellä. Esineen sijainniksi tulee "pientavarahylly" ja painoksi 1.
    ...
    public Esine(String nimi, int paino) {
        ...
        this.paino = paino;
    } //luo esineen annetulla nimellä ja painolla. Esineen sijainniksi tulee "varasto".
